...
package org.ohmcoinj.tools;

import org.ohmcoinj.core.*;
import org.ohmcoinj.core.Wallet.BalanceType;
import org.ohmcoinj.crypto.DeterministicKey;
import org.ohmcoinj.crypto.KeyCrypterException;
import org.ohmcoinj.crypto.MnemonicCode;
import org.ohmcoinj.crypto.MnemonicException;
import org.ohmcoinj.net.discovery.DnsDiscovery;
import org.ohmcoinj.params.MainNetParams;
import org.ohmcoinj.params.RegTestParams;
import org.ohmcoinj.params.TestNet3Params;
import org.ohmcoinj.protocols.payments.PaymentProtocol;
import org.ohmcoinj.protocols.payments.PaymentProtocolException;
import org.ohmcoinj.protocols.payments.PaymentSession;
import org.ohmcoinj.store.*;
import org.ohmcoinj.uri.BitcoinURI;
import org.ohmcoinj.uri.BitcoinURIParseException;
import org.ohmcoinj.utils.BriefLogFormatter;
import org.ohmcoinj.wallet.DeterministicSeed;
import org.ohmcoinj.wallet.DeterministicUpgradeRequiredException;
import org.ohmcoinj.wallet.DeterministicUpgradeRequiresPassword;
...
import org.ohmcoinj.wallet.Protos;
...
import static org.ohmcoinj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static org.ohmcoin.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("bitcoin")) {
            ...
            try {
                paymentRequest = org.ohmcoin.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
