...
import org.ohmcoinj.testing.TestWithWallet;
import org.ohmcoinj.utils.Threading;
import org.ohmcoinj.wallet.WalletFiles;
...
import static org.ohmcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.ohmcoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.ohmcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.ohmcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
