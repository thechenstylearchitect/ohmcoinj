...
import org.ohmcoinj.core.Wallet.SendRequest;
...
import static org.ohmcoinj.core.Utils.HEX;
import static org.ohmcoinj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: ohmcoinj won't check in SPV mode and this is easier than other mutations.
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("ohmcoinj-unit-test", null);
