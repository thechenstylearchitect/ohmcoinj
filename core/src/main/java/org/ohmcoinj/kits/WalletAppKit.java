...
package org.ohmcoinj.kits;

import org.ohmcoinj.core.*;
import org.ohmcoinj.net.discovery.DnsDiscovery;
import org.ohmcoinj.protocols.channels.StoredPaymentChannelClientStates;
import org.ohmcoinj.protocols.channels.StoredPaymentChannelServerStates;
import org.ohmcoinj.store.BlockStoreException;
import org.ohmcoinj.store.SPVBlockStore;
import org.ohmcoinj.store.WalletProtobufSerializer;
import org.ohmcoinj.wallet.DeterministicSeed;
import org.ohmcoinj.wallet.KeyChainGroup;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV ohmcoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit ohmcoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing ohmcoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the ohmcoinj website for further details.
     */
