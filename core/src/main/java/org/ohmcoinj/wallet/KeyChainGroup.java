...
import org.ohmcoinj.crypto.ChildNumber;
...
/**
 * <p>A KeyChainGroup is used by the {@link org.ohmcoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.ohmcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.ohmcoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.ohmcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
