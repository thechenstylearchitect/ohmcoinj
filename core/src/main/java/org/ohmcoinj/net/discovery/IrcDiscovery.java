...
package org.ohmcoinj.net.discovery;

import org.ohmcoinj.core.AddressFormatException;
import org.ohmcoinj.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
    ...
    public InetSocketAddress[] getPeers(long timeoutValue, TimeUnit timeoutUnit) throws PeerDiscoveryException {
        ...
        try {
            ...
            // ohmcoinj but not match the standard nick format, so full peers don't try and connect to us.
