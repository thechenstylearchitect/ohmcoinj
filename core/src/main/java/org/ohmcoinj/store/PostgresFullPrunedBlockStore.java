 ...
 * so you can use {@link #calculateBalanceForAddress(org.ohmcoinj.core.Address)} to quickly look up
...
public class PostgresFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    private void createNewStore(NetworkParameters params) throws BlockStoreException {
        try {
            ...
            StoredUndoableBlock storedGenesis = new StoredUndoableBlock(params.getGenesisBlock().getScryptHash(), genesisTransactions);
    ...
    private void putUpdateStoredBlock(StoredBlock storedBlock, boolean wasUndoable) throws SQLException {
        try {
            ...
            System.arraycopy(storedBlock.getHeader().getScryptHash().getBytes(), 3, hashBytes, 0, 28);
    ...
    public void setChainHead(StoredBlock chainHead) throws BlockStoreException {
        Sha256Hash hash = chainHead.getHeader().getScryptHash();
        this.chainHeadHash = hash;
