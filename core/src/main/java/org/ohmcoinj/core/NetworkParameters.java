...
import org.ohmcoinj.params.*;
import org.ohmcoinj.script.Script;
import org.ohmcoinj.script.ScriptOpCodes;
...
public abstract class NetworkParameters implements Serializable {
    ...
    public static final String ID_MAINNET = "org.ohmcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.ohmcoin.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.ohmcoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.ohmcoinj.unittest";
...
//    protected BigInteger bnProofOfStakeLimit;
    ...
    public static final int TARGET_TIMESPAN = 30 * 30;  // OhmCoin
    public static final int TARGET_SPACING_STAKE = 30;  // OhmCoin
    public static final int TARGET_SPACING_WORK_MAX = 3 * TARGET_SPACING_STAKE;  // OhmCoin
    ...
    public static final long MAX_COINS = 500000000;
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.ohmcoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.ohmcoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.ohmcoinj.core.AlertMessage}s. You can use {@link org.ohmcoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
