...
import org.ohmcoinj.crypto.DRMWorkaround;
import org.ohmcoinj.net.BlockingClientManager;
import org.ohmcoinj.net.ClientConnectionManager;
import org.ohmcoinj.net.FilterMerger;
import org.ohmcoinj.net.NioClientManager;
import org.ohmcoinj.net.discovery.PeerDiscovery;
import org.ohmcoinj.net.discovery.PeerDiscoveryException;
import org.ohmcoinj.net.discovery.TorDiscovery;
import org.ohmcoinj.script.Script;
import org.ohmcoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link org.ohmcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.ohmcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.ohmcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.ohmcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link org.ohmcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.ohmcoinj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a ohmcoinj based app running in SPV mode to fully validating security.
     */
