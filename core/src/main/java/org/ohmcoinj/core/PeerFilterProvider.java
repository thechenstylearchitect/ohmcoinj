 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(org.ohmcoinj.core.PeerGroup.FilterRecalculateMode)}
...
public interface PeerFilterProvider {
     ...
     * possible for the {@link org.ohmcoinj.net.FilterMerger} to request the counts of a bunch of providers
