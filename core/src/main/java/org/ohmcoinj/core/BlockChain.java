...
public class BlockChain extends AbstractBlockChain {
     ...
     * </p>
     *
     * <p>For the store, you should use {@link org.ohmcoinj.store.SPVBlockStore} or you could also try a
     * {@link org.ohmcoinj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
