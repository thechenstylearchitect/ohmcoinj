...
import org.ohmcoinj.utils.MonetaryFormat;
...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.BTC.minDecimals(2).repeatOptionalDecimals(1, 4).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.BTC.minDecimals(0).repeatOptionalDecimals(1, 4).noCode();
