...
import org.ohmcoinj.crypto.TransactionSignature;
...
import static org.ohmcoinj.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, org.ohmcoinj.script.Script, ECKey, org.ohmcoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], org.ohmcoinj.core.Transaction.SigHash, boolean)}
