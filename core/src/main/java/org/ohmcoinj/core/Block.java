...
import static org.ohmcoinj.core.Coin.FIFTY_COINS;
import static org.ohmcoinj.core.Utils.HEX;
import static org.ohmcoinj.core.Utils.doubleDigest;
import static org.ohmcoinj.core.Utils.doubleDigestTwoBuffers;
import static org.ohmcoinj.core.Utils.scryptDigest;
...
public class Block extends Message {
     ...
     *
     * <p>The half-life is controlled by {@link org.ohmcoinj.core.NetworkParameters#getSubsidyDecreaseBlockCount()}.
     * </p>
     */
    ...
    private void parseHeader() throws ProtocolException {
        ...
        scryptHash = new Sha256Hash(Utils.reverseBytes(Utils.scryptDigest(payload, offset, cursor)));
...
// Need to get first transaction to verify proof of stake
//ss << nStakeModifier;
//ss << nTimeBlockFrom << nTxPrevOffset << txPrev.nTime << prevout.n << nTimeTx;
//        if (h.compareTo(target) > 0) {
//            // Proof of work check failed!
//            if (throwException)
//                throw new VerificationException("Hash is higher than target: " + getHashAsString() +
//                		" scrypt hash: " + getScryptHashAsString() + " vs "
//                        + target.toString(16));
//            else
//                return false;
//        }
     ...
     * {@link org.ohmcoinj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
