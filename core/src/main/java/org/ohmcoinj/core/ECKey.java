...
import org.ohmcoin.NativeSecp256k1;
...
public class ECKey implements EncryptableItem, Serializable {
     ...
     * @throws org.ohmcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.ohmcoinj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.ohmcoinj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws org.ohmcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.ohmcoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
