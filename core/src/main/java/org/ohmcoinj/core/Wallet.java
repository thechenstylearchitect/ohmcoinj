...
import org.ohmcoin.protocols.payments.Protos.PaymentDetails;
import org.ohmcoinj.core.TransactionConfidence.ConfidenceType;
import org.ohmcoinj.crypto.*;
import org.ohmcoinj.params.UnitTestParams;
import org.ohmcoinj.script.Script;
import org.ohmcoinj.script.ScriptBuilder;
import org.ohmcoinj.script.ScriptChunk;
import org.ohmcoinj.signers.LocalTransactionSigner;
import org.ohmcoinj.signers.MissingSigResolutionSigner;
import org.ohmcoinj.signers.TransactionSigner;
import org.ohmcoinj.store.UnreadableWalletException;
import org.ohmcoinj.store.WalletProtobufSerializer;
import org.ohmcoinj.utils.BaseTaggableObject;
import org.ohmcoinj.utils.ExchangeRate;
import org.ohmcoinj.utils.ListenerRegistration;
import org.ohmcoinj.utils.Threading;
import org.ohmcoinj.wallet.*;
import org.ohmcoinj.wallet.Protos.Wallet.EncryptionType;
import org.ohmcoinj.wallet.WalletTransaction.Pool;
 ...
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of ohmcoinj,
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.ohmcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link org.ohmcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.ohmcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.ohmcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.ohmcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.ohmcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.ohmcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.ohmcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.ohmcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.ohmcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.ohmcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of ohmcoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.ohmcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.ohmcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.ohmcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.ohmcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.ohmcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.ohmcoinj.crypto.KeyCrypter,
     ...
     * {@link org.ohmcoinj.crypto.KeyCrypterScrypt}.
     *
    ...
    private void receive(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType,
        ...
        log.info("Received tx{} for {}: {} [{}] in block {}", sideChain ? " on a side chain" : "",
                ...
                block != null ? block.getHeader().getScryptHash() : "(unit test)");
    ...
    public void notifyNewBestBlock(StoredBlock block) throws VerificationException {
        ...
        Sha256Hash newBlockHash = block.getHeader().getScryptHash();
     ...
     * of {@link org.ohmcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.ohmcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.ohmcoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link org.ohmcoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link org.ohmcoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
    ...
    public void reorganize(StoredBlock splitPoint, List<StoredBlock> oldBlocks, List<StoredBlock> newBlocks) throws VerificationException {
        ...
        try {
            ...
            for (StoredBlock b : oldBlocks) {
                ...
                oldBlockHashes.add(b.getHeader().getScryptHash());
            }
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.ohmcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.ohmcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link org.ohmcoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
